...
fsp_err_t init_ts(i2c_master_ctrl_t * p_api_ctrl)
{
    ...
    err = R_SCI_B_I2C_SlaveAddressSet( p_api_ctrl, GT_911_I2C_ADDRESS, I2C_MASTER_ADDR_MODE_7BIT);
    if (FSP_SUCCESS == err)
    {
...
fsp_err_t enable_ts(i2c_master_ctrl_t * p_api_i2c_ctrl, external_irq_ctrl_t * p_api_irq_ctrl)
{
    ...
    err = R_SCI_B_I2C_SlaveAddressSet( p_api_i2c_ctrl, GT_911_I2C_ADDRESS, I2C_MASTER_ADDR_MODE_7BIT);
    if (FSP_SUCCESS == err)
    {
